...
const LeftSidebar = ({
  ...
  return (
    <div style={sidebarStyles} className={isAnimating ? 'sidebar-animating' : ''}>
      {/* Sidebar Header */}
      <div style={styles.sidebarHeader}>
        ...
        {!isMobile && (
          <button
            ...
            onClick={onToggle}
            title={collapsed ? (t ? t('expand_sidebar') : 'Expand Sidebar') : (t ? t('collapse_sidebar') : 'Collapse Sidebar')}
          >
            {collapsed ? '»' : '«'}
          </button>
        )}
