...
class ResultAggregator:
    ...
    async def aggregate_results(self, expert_results: List[Tuple[Expert, Dict[str, Any]], 
                           method: str = "best_confidence") -> AggregatedResult:
    ...
    async def _best_confidence_aggregation(self, expert_results: List[Tuple[Expert, Dict[str, Any]]]) -> Tuple[Dict[str, Any], List[Tuple[str, Dict[str, Any]]]]:
    ...
    async def _weighted_average_aggregation(self, expert_results: List[Tuple[Expert, Dict[str, Any]]]) -> Tuple[Dict[str, Any], List[Tuple[str, Dict[str, Any]]]]:
    ...
    async def _majority_vote_aggregation(self, expert_results: List[Tuple[Expert, Dict[str, Any]]]) -> Tuple[Dict[str, Any], List[Tuple[str, Dict[str, Any]]]:
    ...
    async def _consensus_aggregation(self, expert_results: List[Tuple[Expert, Dict[str, Any]]]) -> Tuple[Dict[str, Any], List[Tuple[str, Dict[str, Any]]]:
    ...
    def _calculate_confidence(self, expert_results: List[Tuple[Expert, Dict[str, Any]], primary_result: Dict[str, Any]) -> float:
...
class MoERouter:
    ...
    async def _execute_with_multiple_experts(self, task: Task, selection: ExpertSelection) -> List[Tuple[Expert, Dict[str, Any]]]:
