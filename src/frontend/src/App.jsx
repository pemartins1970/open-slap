...
const App = () => {
  const { user, loading, login, logout, getAuthHeaders, isAuthenticated } = useAuth();
  ...
  const loadConversations = async () => {
    try {
      ...
      console.log('Headers para loadConversations:', headers);
      if (!headers.Authorization) {
        console.log('Aguardando token para carregar conversas...');
        return;
      }
  ...
  const sendMessage = () => {
    ...
    // Adicionar mensagem placeholder para streaming
