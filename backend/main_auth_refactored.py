...
from .utils.auth_helpers import PUBLIC_PATHS, PUBLIC_PATH_PREFIXES, extract_bearer_token_from_headers
...
app.include_router(autoapprove_routes.router, prefix="/api/autoapprove", tags=["autoapprove"])
...
app.include_router(mcp_registry_routes.router, prefix="/api/mcp", tags=["mcp"])
...
app.include_router(referral_routes.router, prefix="/api/referral", tags=["referral"])
...
async def websocket_endpoint(websocket: WebSocket, session_id: str):
    token = websocket.query_params.get("token") or extract_bearer_token_from_headers(
